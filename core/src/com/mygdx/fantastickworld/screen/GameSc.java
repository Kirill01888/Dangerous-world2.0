...
public class GameSc extends State implements Screen {
    ...
    public void loadActors() {
        ...
        enemies = new Array<>();
        bullets = new Array<>();
        player = new Player(Main.mage, new Point2D(Main.WIDTH / 2, Main.HEIGHT / 2), 10, Main.HEIGHT / 20, 20, 0);
    ...
    public void GameRender(SpriteBatch batch) {
        ...
        //timeFont.draw(batch, gl3,player.position.getX() + 1000 ,player.position.getY() + 500);
